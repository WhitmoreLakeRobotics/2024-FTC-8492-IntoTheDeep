...
//@Disabled
@Autonomous(name = "AutonRightMultiSpecimen2", group = "Auton")
// @Autonomous(...) is the other common choice

public class AutonRightMultiSpecimen2 extends OpMode {
   ...
   // private double AUTO_TURN_SPEED = DriveTrain.DRIVETRAIN_TURNSPEED;
    ...
    public void init() {
        ...
        robot.init();
        telemetry.addData("Test AutonRightMultiSpecimen2", "Initialized");
