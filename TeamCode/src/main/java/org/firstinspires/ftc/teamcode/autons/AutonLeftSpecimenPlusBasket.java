...
//@Disabled
@Autonomous(name = "AutonLeftSpecimenPlusBasket", group = "Auton")
// @Autonomous(...) is the other common choice

public class AutonLeftSpecimenPlusBasket extends OpMode {
   ...
   // private double AUTO_TURN_SPEED = DriveTrain.DRIVETRAIN_TURNSPEED;
    ...
    public void init() {
        ...
        robot.init();
        telemetry.addData("Test AutonLeftSpecimenPlusBasket", "Initialized");
        ...
        switch (currentStage){
            ...
            case _70_Turn:
                if(robot.driveTrain.getCmdComplete()){
                    ...
                    currentStage = stage._80_Arm_Pickup;
                }
                break;
            case _80_Arm_Pickup:
                if(robot.arm.getCmdComlete()){
                    ...
                    runtime.reset();
                    currentStage = stage._90_Pick_Up;
                }
                break;
            case _90_Pick_Up:
                if (runtime.milliseconds() > 1000) {
                    robot.driveTrain.CmdDrive(5,-90,10,-90);
                    currentStage = stage._100_Arm_Neutral;
                }
                break;
            case _100_Arm_Neutral:
                if(robot.driveTrain.getCmdComplete()){
