...
@Disabled
@Autonomous(name = "AutonTopBasketPark", group = "Auton")
// @Autonomous(...) is the other common choice

public class AutonTopBasketPark extends OpMode {
   ...
   // private double AUTO_TURN_SPEED = DriveTrain.DRIVETRAIN_TURNSPEED;
    ...
    public void init() {
        ...
        robot.init();
        telemetry.addData("Test AutonTopBasketPark", "Initialized");
    ...
    public void loop() {
        ...
        switch (currentStage){
            ...
            case _50_Strafe_Right:
                if (robot.driveTrain.getCmdComplete()){
                    robot.driveTrain.CmdDrive(20,90,0.0,0);
