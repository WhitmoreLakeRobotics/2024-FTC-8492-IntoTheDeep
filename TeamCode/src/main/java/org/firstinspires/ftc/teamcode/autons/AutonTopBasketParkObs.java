...
//@Disabled
@Autonomous(name = "AutonTopBasketParkObs", group = "Auton")
// @Autonomous(...) is the other common choice

public class AutonTopBasketParkObs extends OpMode {
   ...
   // private double AUTO_TURN_SPEED = DriveTrain.DRIVETRAIN_TURNSPEED;
    ...
    public void init() {
        ...
        robot.init();
        telemetry.addData("Test AutonTopBasketParkObs", "Initialized");
        ...
        switch (currentStage){
            ...
            case _20_Strafe_Left:
                if(robot.driveTrain.getCmdComplete()){
                    robot.driveTrain.CmdDrive(0.5,-90,0.35,-90);
